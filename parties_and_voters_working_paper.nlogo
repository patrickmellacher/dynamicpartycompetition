...
to follow_party_strategy
  ...
  [
    set xcor precision ( mean  [xcor] of humans with [voting_for = myself]) 8
    set ycor precision (mean  [ycor] of humans with [voting_for = myself]) 8
  ]
...
to update_opinions
  ...
  [
    ...
    ;[
    ;  set xcor (1 - party_identification_effect) * xcor + (party_identification_effect) * [xcor] of voting_for
    ;  set ycor (1 - party_identification_effect) * ycor + (party_identification_effect) * [ycor] of voting_for
    ;]
  ]
end
...
573
file_name
party_and_voter_positions_noise_bc1
1
0
String
...
@#$#@#$#@
<experiments>
  <experiment name="voting_experiment_X1" repetitions="1" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup
...
set measure_polarization_yes_no true
    ...
    <steppedValueSet variable="opinion_change" first="0" step="0.01" last="0.1"/>
    <steppedValueSet variable="party_identification_effect" first="0" step="0.01" last="0.1"/>
  </experiment>
  <experiment name="voting_experiment_X2" repetitions="1" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup
set measure_polarization_yes_no false</setup>
    <go>go
if ticks = 498
...
set measure_polarization_yes_no true
  ...
  <experiment name="voting_experiment_X3" repetitions="1" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup
set measure_polarization_yes_no false</setup>
    <go>go
if ticks = 498
...
set measure_polarization_yes_no true
  ...
  <experiment name="voting_experiment_X4" repetitions="1" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup
set measure_polarization_yes_no false</setup>
    <go>go
if ticks = 498
...
set measure_polarization_yes_no true
  ...
  <experiment name="voting_experiment_X5" repetitions="1" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup
set measure_polarization_yes_no false</setup>
    <go>go
if ticks = 498
...
set measure_polarization_yes_no true
  ...
  <experiment name="voting_experiment_X6" repetitions="1" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup
set measure_polarization_yes_no false</setup>
    <go>go
if ticks = 498
...
set measure_polarization_yes_no true
  ...
  <experiment name="voting_experiment_X7" repetitions="1" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup
set measure_polarization_yes_no false</setup>
    <go>go
if ticks = 498
...
set measure_polarization_yes_no true
  ...
  <experiment name="voting_experiment_X8" repetitions="1" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup
set measure_polarization_yes_no false</setup>
    <go>go
if ticks = 498
...
set measure_polarization_yes_no true
  ...
  <experiment name="voting_experiment_X9" repetitions="1" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup
set measure_polarization_yes_no false</setup>
    <go>go
if ticks = 498
...
set measure_polarization_yes_no true
  ...
  <experiment name="voting_experiment_X10" repetitions="1" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup
set measure_polarization_yes_no false</setup>
    <go>go
if ticks = 498
...
set measure_polarization_yes_no true
  ...
  <experiment name="voting_experiment_X11" repetitions="1" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup
set measure_polarization_yes_no false</setup>
    <go>go
if ticks = 498
...
set measure_polarization_yes_no true
    ...
    <steppedValueSet variable="opinion_change" first="0" step="0.01" last="0.1"/>
    <steppedValueSet variable="party_identification_effect" first="0.11" step="0.01" last="0.2"/>
  </experiment>
  <experiment name="voting_experiment_X12" repetitions="1" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup
set measure_polarization_yes_no false</setup>
    <go>go
if ticks = 498
...
set measure_polarization_yes_no true
  ...
  <experiment name="voting_experiment_X13" repetitions="1" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup
set measure_polarization_yes_no false</setup>
    <go>go
if ticks = 498
...
set measure_polarization_yes_no true
  ...
  <experiment name="voting_experiment_X14" repetitions="1" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup
set measure_polarization_yes_no false</setup>
    <go>go
if ticks = 498
...
set measure_polarization_yes_no true
  ...
  <experiment name="voting_experiment_X15" repetitions="1" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup
set measure_polarization_yes_no false</setup>
    <go>go
if ticks = 498
...
set measure_polarization_yes_no true
  ...
  <experiment name="voting_experiment_X16" repetitions="1" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup
set measure_polarization_yes_no false</setup>
    <go>go
if ticks = 498
...
set measure_polarization_yes_no true
  ...
  <experiment name="voting_experiment_X17" repetitions="1" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup
set measure_polarization_yes_no false</setup>
    <go>go
if ticks = 498
...
set measure_polarization_yes_no true
  ...
  <experiment name="voting_experiment_X18" repetitions="1" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup
set measure_polarization_yes_no false</setup>
    <go>go
if ticks = 498
...
set measure_polarization_yes_no true
  ...
  <experiment name="voting_experiment_X19" repetitions="1" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup
set measure_polarization_yes_no false</setup>
    <go>go
if ticks = 498
...
set measure_polarization_yes_no true
  ...
  <experiment name="voting_experiment_X20" repetitions="1" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup
set measure_polarization_yes_no false</setup>
    <go>go
if ticks = 498
...
set measure_polarization_yes_no true
  ...
  <experiment name="voting_experiment_X21" repetitions="1" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup
set measure_polarization_yes_no false</setup>
    <go>go
if ticks = 498
...
set measure_polarization_yes_no true
    ...
    <steppedValueSet variable="opinion_change" first="0.11" step="0.01" last="0.2"/>
    <steppedValueSet variable="party_identification_effect" first="0.11" step="0.01" last="0.2"/>
  </experiment>
  <experiment name="voting_experiment_X22" repetitions="1" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup
set measure_polarization_yes_no false</setup>
    <go>go
if ticks = 498
...
set measure_polarization_yes_no true
  ...
  <experiment name="voting_experiment_X23" repetitions="1" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup
set measure_polarization_yes_no false</setup>
    <go>go
if ticks = 498
...
set measure_polarization_yes_no true
  ...
  <experiment name="voting_experiment_X24" repetitions="1" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup
set measure_polarization_yes_no false</setup>
    <go>go
if ticks = 498
...
set measure_polarization_yes_no true
  ...
  <experiment name="voting_experiment_X25" repetitions="1" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup
set measure_polarization_yes_no false</setup>
    <go>go
if ticks = 498
...
set measure_polarization_yes_no true
  ...
  <experiment name="voting_experiment_X26" repetitions="1" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup
set measure_polarization_yes_no false</setup>
    <go>go
if ticks = 498
...
set measure_polarization_yes_no true
  ...
  <experiment name="voting_experiment_X27" repetitions="1" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup
set measure_polarization_yes_no false</setup>
    <go>go
if ticks = 498
...
set measure_polarization_yes_no true
  ...
  <experiment name="voting_experiment_X28" repetitions="1" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup
set measure_polarization_yes_no false</setup>
    <go>go
if ticks = 498
...
set measure_polarization_yes_no true
  ...
  <experiment name="voting_experiment_X29" repetitions="1" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup
set measure_polarization_yes_no false</setup>
    <go>go
if ticks = 498
...
set measure_polarization_yes_no true
  ...
  <experiment name="voting_experiment_X30" repetitions="1" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup
set measure_polarization_yes_no false</setup>
    <go>go
if ticks = 498
...
set measure_polarization_yes_no true
  ...
  <experiment name="voting_experiment_X31" repetitions="1" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup
set measure_polarization_yes_no false</setup>
    <go>go
if ticks = 498
...
set measure_polarization_yes_no true
  ...
  <experiment name="voting_experiment_X32" repetitions="1" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup
set measure_polarization_yes_no false</setup>
    <go>go
if ticks = 498
...
set measure_polarization_yes_no true
  ...
  <experiment name="voting_experiment_X33" repetitions="1" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup
set measure_polarization_yes_no false</setup>
    <go>go
if ticks = 498
...
set measure_polarization_yes_no true
  ...
  <experiment name="voting_experiment_X34" repetitions="1" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup
set measure_polarization_yes_no false</setup>
    <go>go
if ticks = 498
...
set measure_polarization_yes_no true
  ...
  <experiment name="voting_experiment_X35" repetitions="1" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup
set measure_polarization_yes_no false</setup>
    <go>go
if ticks = 498
...
set measure_polarization_yes_no true
  ...
  <experiment name="voting_experiment_X36" repetitions="1" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup
set measure_polarization_yes_no false</setup>
    <go>go
if ticks = 498
...
set measure_polarization_yes_no true
  ...
  <experiment name="voting_experiment_X37" repetitions="1" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup
set measure_polarization_yes_no false</setup>
    <go>go
if ticks = 498
...
set measure_polarization_yes_no true
  ...
  <experiment name="voting_experiment_X38" repetitions="1" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup
set measure_polarization_yes_no false</setup>
    <go>go
if ticks = 498
...
set measure_polarization_yes_no true
  ...
  <experiment name="voting_experiment_X39" repetitions="1" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup
set measure_polarization_yes_no false</setup>
    <go>go
if ticks = 498
...
set measure_polarization_yes_no true
  ...
  <experiment name="voting_experiment_X40" repetitions="1" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup
set measure_polarization_yes_no false</setup>
    <go>go
if ticks = 498
